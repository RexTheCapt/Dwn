...
namespace Assets.PsdToUnity.Editor.FullSerializer.Aot
{
    ...
    public class FsAotCompilationManager
    {
        ...
        ///     be recompiled.
        /// </summary>
        public static bool IsAotModelUpToDate(fsMetaType currentModel, IFsIAotConverter aotModel)
        {
        ...
        private static string EmitVersionInfo(string prefix, fsMetaProperty[] members,
            ...
            bool isConstructorPublic)
        {
            ...
            sb.AppendLine("        private fsAotVersionInfo _versionInfo = " +
                          EmitVersionInfo("        ", members, isConstructorPublic) + ";");
